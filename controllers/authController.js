...
//     const cookieDomain = process.env.STELLARTERM_ROOT_DOMAIN || undefined;
...
//     res.cookie('accessToken', accessToken, { ...cookieOptions, expires: new Date(Date.now() + 15 * 60 * 1000) });

//     if (redirectOverride) {
//         // Updated default port to Next.js (3000)
...
//         // ... (Keep existing cookie options logic) ...
//         const cookieOptions = {
//             expires: new Date(Date.now() + 7 * 24 * 60 * 60 * 1000),
//             httpOnly: true, path: '/', domain: cookieDomain
//         };
//         // (Simplified for brevity, keep your env checks)
...
//     // Updated logic for StellarTerm roles
...
//     const cookieDomain = process.env.STELLARTERM_ROOT_DOMAIN || undefined;
//     const cookieOptions = { httpOnly: true, expires: new Date(0), path: '/', domain: cookieDomain, secure: process.env.NODE_ENV === 'production', sameSite: process.env.NODE_ENV === 'production' ? 'none' : 'lax' };
